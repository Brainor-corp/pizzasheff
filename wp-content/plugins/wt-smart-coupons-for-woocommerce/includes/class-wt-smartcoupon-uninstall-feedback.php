...
if (!class_exists('WT_SamrtCoupon_Uninstall_Feedback')) :
    ...
    class WT_SamrtCoupon_Uninstall_Feedback {
                        ...
                        modal.on('click', 'input[type="radio"]', function () {
                            ...
                            var inputType = parent.data('type'),
                                ...
                                if ('reviewhtml' === inputType) {
                                    var reasonInputHtml = '<div class="reviewlink"><a href="#" target="_blank" class="review-and-deactivate"><?php _e('Deactivate and leave a review', 'wt-smart-coupons-for-woocommerce'); ?> <span class="wt-smartcoupon-rating-link"> &#9733;&#9733;&#9733;&#9733;&#9733; </span></a></div>';
                                } else {
        ...
        public function send_uninstall_reason() {
            ...
            $resp = wp_remote_post('http://feedback.webtoffee.com/wp-json/smartcoupon/v1/uninstall', array(
                'method' => 'POST',
                'timeout' => 45,
                'redirection' => 5,
                'httpversion' => '1.0',
